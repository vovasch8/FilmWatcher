    ...
    <div class="container mt-5  min-vh-100">
        <div class="row">
            ...
            <div class="search col-lg-4">
                <input id="input-search" type="text" class="form-control d-inline" placeholder="Пошук" style="max-width: 250px;">
                            ...
                            <div class="btn-panel d-flex">
                                ...
                                @auth
                                    <div data-id_film="{{$film->id}}" class="btn-group ms-auto">
                                        ...
                                        @else
                                            <i onclick="addFilm(this)" class="bi bi-plus-circle btn btn-outline-dark" style="font-size: 18px;"></i>
                                        @endif
        ...
        <div class="row">
            <button onclick="loadContent(this)" id="load-more" style="width: 200px" class="btn btn-dark mx-auto mt-3 mb-3">Загрузити ще...</button>
        </div>
    </div>
@endsection
